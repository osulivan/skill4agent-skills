...
注：对于包含脚本并存在敏感代码的技能，安装后需对script_check_notes中列出的敏感代码所在位置进行复检，确保安全
...
4. **安装**：使用安装命令或下载zip安装技能
5. **脚本安全复检**：如技能包含脚本并存在敏感代码，安装后需对script_check_notes中列出的敏感代码所在位置进行复检，确保安全
